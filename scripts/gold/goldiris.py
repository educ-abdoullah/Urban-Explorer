...
SILVER_DATA_DIR = get_latest_day_dir(SILVER_DATA_DIR)
INDICE_IMVU_SILVER = SILVER_DATA_DIR
date_jour = SILVER_DATA_DIR.name
GOLD_DATA_DIR = PROJECT_ROOT / "data" / "gold"/date_jour
