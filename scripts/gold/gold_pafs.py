...
SILVER_BASE_DIR: Final[Path] = DATA_DIR / "silver"
GOLD_BASE_DIR: Final[Path] = DATA_DIR / "gold"
QUARTIERS_DATA_DIR: Final[Path] = DATA_DIR / "quartiers"
...
SILVER_DATA_DIR: Final[Path] = get_latest_day_dir(SILVER_BASE_DIR)
RUN_DAY: Final[str] = SILVER_DATA_DIR.name
GOLD_DATA_DIR: Final[Path] = GOLD_BASE_DIR / RUN_DAY
