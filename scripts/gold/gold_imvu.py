...
iris = gpd.read_file(os.path.join(latest_silver_dir, "iris_silver.geojson"))
arbres = gpd.read_file(os.path.join(latest_silver_dir, "arbres_silver.geojson"))
parcs = gpd.read_file(os.path.join(latest_silver_dir, "espaces_verts_silver.geojson"))
jardins = gpd.read_file(os.path.join(latest_silver_dir, "jardins_partages_silver.geojson"))
...
fichier_csv = os.path.join(GOLD_DAY_DIR, "imvu_scores_iris.csv")
...
fichier_geojson = os.path.join(GOLD_DAY_DIR, "imvu_carte_iris_web.geojson")
